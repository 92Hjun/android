...
public class MainActivity extends AppCompatActivity {
    ...
    public void selectData(String tableName){
        ...
        if (db != null) {
            ...
            println("select item num : " + cursor.getCount());
    ...
    public void createTable (String tableName) {
        ...
        if (db != null){
            ...
            println("데이터베이스를 오픈하세요.");
            Toast.makeText(getApplicationContext(), "데이터베이스가 생성되지 않았습니다." , Toast.LENGTH_SHORT).show();
        }
    }
